...
public class L {
	...
	public final static String TAG = "positive";
	...
	public static void v(String tag, String type, String msg1, String msg2,
		...
		if (!mode_for_release) {
			String des = String.format("[%s][%s]%s%s%s%s", tag, type, msg1,
					msg2, msg3, msg4);
			Log.v(TAG, des);
		}
	}
	...
	public static void v(String tag, String type, Object msg1, Object msg2,
			Object msg3, Object msg4) {
		if (!mode_for_release) {
			String des = String.format("[%s][%s]%s%s%s%s", tag, type,
					String.valueOf(msg1), String.valueOf(msg2),
					String.valueOf(msg3), String.valueOf(msg4));
			Log.v(TAG, des);
		}
	}
	...
	public static void v(String tag, String type, Object msg1, Object msg2) {
		if (!mode_for_release) {
			String des = String.format("[%s][%s]%s%s", tag, type,
					String.valueOf(msg1), String.valueOf(msg2));
			Log.v(TAG, des);
		}
	}
	...
	public static void e(String tag, String type) {
		if (!mode_for_release) {
